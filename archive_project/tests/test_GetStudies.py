...
class TestGetStudies(unittest.TestCase):
	...
	def test_get_studies_integer(self):
		...
		self.assertEqual((type(47), "is not a valid input type. Nothing will be uploaded. Please enter path to a file or a list of study names\n"), message)
	...
	def test_file_and_fail(self):
		...
		self.assertEqual(expected,actual)
		self.assertEqual("This file can't be found. Attempt will be made to interpret as a list. If this is not intended then please enter a valid path to a file or a list of study names.\n",message)
